...
plot(y = data$malignant, x = data$tumor.size, main = "Malignidad del tumor según su tamaño",ylab = "Tipo (0 = benigno, 1 = canceroso)", xlab = "Tamaño del tumor")
...
$$\textrm{Malignidad del tumor} = 0,204+0,061 ×\textrm{Tamaño del tumor} $$
...
plot(y = data$malignant, x = data$tumor.size, main = "Malignidad del tumor según su tamaño",
ylab = "Tipo (0 = benigno, 1 = canceroso)", xlab = "Tamaño del tumor")
abline(v = 4.5)
```
...
````{r, fig.align="center", fig.cap="*Figura 4-14. La clasificación uno vs muchos utiliza el mismo enfoque que la clasificación estándar, pero reclasifica otros grupos en un solo grupo para comparar*"}
par(mfrow = c(1, 3))
