...
Comenzamos con las entradas $X1$, $X2$ y el nodo de polarización que es solo una constante aditiva. Calculamos todos estos en el círculo vacío, esto es un nodo de cálculo. El cálculo que realizamos es poner todas estas cosas en una función de activación, que casi siempre es una función sigmoide. La salida de la función sigmoide es la resultado de la red neuronal.
